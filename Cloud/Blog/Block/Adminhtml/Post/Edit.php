<?php
namespace Cloud\Blog\Block\Adminhtml\Post;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Cloud_Blog';
        $this->_controller = 'adminhtml_post';

        parent::_construct();

        if ($this->_isAllowedAction('Cloud_Blog::save')) {
        ...
        if ($this->_isAllowedAction('Cloud_Blog::post_delete')) {
